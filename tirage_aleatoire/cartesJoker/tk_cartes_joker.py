...
if __name__ == '__main__':
    ...
    ##frame1.grid()
    frame1.place(relx=0,rely=0, height=440, width=450)


    #instanciation
    jeu = JOKER.Jeu_cartes54()

    #MELANGER - BOUTON

    #création du BOUTON mélanger - grid et placeZ
    melanger_bt = Button(frame1, text="Mélanger", bg="yellow", command=melanger)
